...
def write_frozen_factory_strategy(
    ...
    *,
    ...
    The directory is not trusted merely because this function wrote it. Callers
    must build and verify a StrategyArtifactManifest over the completed directory
    before registering it for SHADOW/PAPER/LIVE use.
    """
