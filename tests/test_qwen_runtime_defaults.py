from stock_trading.experiments.enrich import LdaEnrichmentConfig
...
from stock_trading.live.run_current_usaspending_shadow import (
    DEFAULT_QWEN_BASE_URL as USASPENDING_DEFAULT_QWEN_BASE_URL,
    DEFAULT_QWEN_MODEL as USASPENDING_DEFAULT_QWEN_MODEL,
)
...
def test_qwen_defaults_match_validated_ollama_runtime(tmp_path) -> None:
    ...
    historical = LdaEnrichmentConfig(data_root=tmp_path)
    ...
    assert historical.qwen_base_url == DEFAULT_QWEN_BASE_URL
    assert historical.qwen_model == DEFAULT_QWEN_MODEL
    assert LDA_DEFAULT_QWEN_BASE_URL == DEFAULT_QWEN_BASE_URL
    assert LDA_DEFAULT_QWEN_MODEL == DEFAULT_QWEN_MODEL
    assert USASPENDING_DEFAULT_QWEN_BASE_URL == DEFAULT_QWEN_BASE_URL
    assert USASPENDING_DEFAULT_QWEN_MODEL == DEFAULT_QWEN_MODEL
